        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form id="agregar-form" class="p-4 md:p-5" enctype="multipart/form-data" action="{{ route('productos.store') }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="producto" class="block mt-1 w-full" type="text" name="producto" required />
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form id="editar-form" class="p-4 md:p-5" enctype="multipart/form-data" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <input id="edit-producto" class="block mt-1 w-full text-sm dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="text" name="producto" required>
                </div>
                <div class="mt-4">
                    <label for="edit-cantidad" class="block text-sm font-medium text-gray-900 dark:text-gray-300">Cantidad</label>
                    <input id="edit-cantidad" class="block mt-1 w-full text-sm dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="number" name="cantidad" required>
                </div>
                <div class="mt-4">
                    <label for="edit-precio" class="block text-sm font-medium text-gray-900 dark:text-gray-300">Precio</label>
                    <input id="edit-precio" class="block mt-1 w-full text-sm dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="text" name="precio" required>
                </div>
                <div class="flex items-center justify-end mt-4">
                    <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Editar Producto
