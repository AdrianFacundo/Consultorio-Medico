    ...
    <div class="py-12">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex justify-between items-center">
                    <span>{{ __("Tabla de usuarios") }}</span>
                    <div class="flex space-x-4">
                        ...
                        <button data-modal-target="eliminar-usuario-modal" data-modal-toggle="eliminar-usuario-modal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                            Eliminar Usuario
                        </button>
                ...
                <div class="flex items-center justify-end mt-4">
                    <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        <svg class="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M16.707 6.293a1 1 0 0 0-1.414 0L10 11.586 7.707 9.293a1 1 0 0 0-1.414 1.414l3 3a1 1 0 0 0 1.414 0l6-6a1 1 0 0 0 0-1.414z" clip-rule="evenodd"/>
                        </svg>
                        Registrar
                    </button>
                </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form method="POST" action="{{ route('users.destroy', ['id' => 0]) }}" class="p-4 md:p-5" id="delete-user-form">
                ...
                <!-- Nombre del Usuario -->
                <div class="mt-4">
                    <x-input-label for="delete_user_id" :value="__('Nombre del Usuario')" />
